...
namespace NX_Code_Macro
{
    class fitCons
    {
        public void ApplyFit(Part Assem, ComponentPositioner componentPositioner1, ConstData constinfo)
        {
            ...
            compoConst.ConstraintType = NXOpen.Positioning.Constraint.Type.Fit; //3
