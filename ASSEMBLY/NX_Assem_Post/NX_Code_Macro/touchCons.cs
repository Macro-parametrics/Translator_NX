...
namespace NX_Code_Macro
{
    class touchCons
    {
        public void ApplyTouch(Part Assem, ComponentPositioner componentPositioner1, ConstData constinfo)
        {
            ...
            compoConst.ConstraintType = NXOpen.Positioning.Constraint.Type.Touch; //3
